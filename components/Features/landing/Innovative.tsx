...
function Innovative() {
  return (
    <section className="flex justify-center bg-black py-[50px] text-white lg:px-16 lg:py-20">
      <div className="w-[335px] md:w-2/3 lg:grid lg:w-full lg:grid-cols-12 lg:items-baseline lg:gap-20">
        ...
        {/* col-6 */}
        <article className="mb-12 mt-5 flex w-full flex-col items-center justify-center lg:col-span-6 lg:mb-0 lg:items-start lg:justify-start">
