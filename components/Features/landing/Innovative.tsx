...
function Innovative() {
  return (
    <section className="flex flex-col items-center justify-center bg-black py-[50px] text-white md:px-16 md:py-20">
      <div className="w-[335px] md:grid md:w-full md:grid-cols-12 md:gap-20">
        ...
        <div className="flex flex-col gap-8 md:w-full md:flex-row md:justify-between 2xl:flex">
